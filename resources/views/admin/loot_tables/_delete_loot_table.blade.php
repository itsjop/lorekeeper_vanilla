@if ($table)
  ...
  <p>You are about to delete the loot table
    <strong>{{ $table->name }}</strong>. This is not reversible. If prompts
    that use this loot table exist, you will not be able to delete this table.
  </p>
