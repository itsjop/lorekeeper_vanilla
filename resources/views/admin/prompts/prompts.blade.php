...
@section('admin-content')
  ...
  <div>
    ...
    <div class="form-group mr-3 mb-3">
      {!! Form::select('prompt_category_id', $categories, Request::get('name'), [
          'class' => 'form-control'
      ]) !!}
    </div>
  ...
  @else
      ...
      @foreach ($prompts as $prompt)
        <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
          ...
          <div class="col-3 col-md-1 text-right">
            <a href="{{ url('admin/data/prompts/edit/' . $prompt->id) }}"
    ...
    <div class="text-center mt-4 small text-muted">{{ $prompts->total() }}
      result{{ $prompts->total() == 1 ? '' : 's' }}
      found.</div>
  @endif
