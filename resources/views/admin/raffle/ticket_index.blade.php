      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            {!! Form::label('names', 'Names (comma-separated, one name per ticket)') !!} {!! add_help(
                'Names will be matched to usernames on the site. If a matching username is not found, it will add a ticket as a deviantART username instead.'
            ) !!}
