<div class="card mb-3 stock {{ $stock ? '' : 'hide' }}">
  <div class="card-body">
    <div class="text-right mb-3">
      <a href="#" class="remove-stock-button btn btn-danger">Remove</a>
    </div>
    <div class="form-group">
      {!! Form::label('item_id[' . $key . ']', 'Item') !!}
      {!! Form::select('item_id[' . $key . ']', $items, $stock ? $stock->item_id : null, [
    ...
    <div class="form-group">
      ...
      <div class="row">
        <div class="col-4">
          {!! Form::text('cost[' . $key . ']', $stock ? $stock->cost : null, [
              'class' => 'form-control stock-field',
              'data-name' => 'cost'
          ]) !!}
        </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          {!! Form::checkbox('use_user_bank[' . $key . ']', 1, $stock ? $stock->use_user_bank : 1, [
    ...
    >
      <div class="card-body">
        <div>
          ...
          {!! Form::text('quantity[' . $key . ']', $stock ? $stock->quantity : 0, [
              'class' => 'form-control stock-field',
              'data-name' => 'quantity'
          ]) !!}
        </div>
    ...
    <div>
      {!! Form::label('purchase_limit[' . $key . ']', 'User Purchase Limit') !!} {!! add_help(
          'This is the maximum amount of this item a user can purchase from this shop. Set to 0 to allow infinite purchases.'
      ) !!}
      {!! Form::text('purchase_limit[' . $key . ']', $stock ? $stock->purchase_limit : 0, [
          'class' => 'form-control stock-field',
