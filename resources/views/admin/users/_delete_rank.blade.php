@if ($rank)
  ...
  <p>You are about to delete the rank <strong>{{ $rank->name }}</strong>. This
    is not reversible and you will only be
    able to delete it if there are no users with this rank.</p>
