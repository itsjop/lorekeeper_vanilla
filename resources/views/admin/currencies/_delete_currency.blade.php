@if ($currency)
  ...
  <p>You are about to delete the currency
    <strong>{{ $currency->name }}</strong>. This is not reversible. If users who
    possess this currency exist, their owned currency will also be deleted.
  </p>
