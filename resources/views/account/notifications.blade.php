      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
          ...
          <a
            ...
            href="#{{ str_replace(' ', '_', Config::get('lorekeeper.notifications.' . $type . '.name')) }}"
            data-toggle="collapse"
          >{{ Config::get('lorekeeper.notifications.' . $type . '.name') }}
          </a>
          <div
            id="{{ str_replace(' ', '_', Config::get('lorekeeper.notifications.' . $type . '.name')) }}"
