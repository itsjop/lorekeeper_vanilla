...
</i> {{ $bookmark ? 'Edit Bookmark' : 'Bookmark' }}</a>
    @endif
...
<i class="fas fa-home">
        ...
        @endif
    @if(!$character->is_visible) <i class="fas fa-eye-slash">
</i> @endif {!! $character->displayName !!}
</h1>
<div class="mb-3">
