...
<div class="form-group">
  {!! Form::label('Species') !!}
  {!! Form::select('species_id', $specieses, $image->species_id, [
      'class' => 'form-control',
      'id' => 'species'
  ]) !!}
</div>
...
<div class="form-group" id="subtypes">
  ...
  {!! Form::select('subtype_id', $subtypes, $image->subtype_id, [
      'class' => 'form-control',
      'id' => 'subtype'
  ]) !!}
</div>
...
<script>
  ...
  $("#species").change(function() {
    ...
    $.ajax({
      type: "GET",
      url: "{{ url('admin/character/image/traits/subtype') }}?species=" + species + "&id=" +
        id,
      dataType: "text"
    }).done(function(res) {
      $("#subtypes").html(res);
    ...
    $.ajax({
      type: "GET",
      url: "{{ url('admin/character/image/traits/transformation') }}?species=" + species +
        "&id=" + id,
      dataType: "text"
    }).done(function(res) {
