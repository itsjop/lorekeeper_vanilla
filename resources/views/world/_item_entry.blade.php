...
<img src="{{ $imageUrl }}" class="world-entry-image" alt="{{ $name }}"/>
    ...
    <div class="{{ $imageUrl ? 'col-md-9' : 'col-12' }}">
        <h3>{!! $name !!} @if(isset($idUrl) && $idUrl) <a href="{{ $idUrl }}" class="world-entry-search text-muted">
...
<strong>Purchaseable At:</strong>
                                ...
                                <div class="row">
                                    @foreach($shops as $shop) <div class="col">
...
<strong>Drops From:</strong>
                                ...
                                <div class="row">
                                    @foreach($item->prompts as $prompt) <div class="col">
