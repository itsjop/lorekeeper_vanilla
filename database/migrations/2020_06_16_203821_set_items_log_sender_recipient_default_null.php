...
class SetItemsLogSenderRecipientDefaultNull extends Migration {
  ...
  public function up() {
    ...
    DB::statement(
      "ALTER TABLE items_log CHANGE COLUMN sender_type sender_type ENUM('User', 'Character') DEFAULT NULL"
    );
    DB::statement(
      "ALTER TABLE items_log CHANGE COLUMN recipient_type recipient_type ENUM('User', 'Character') DEFAULT NULL"
    );
  ...
  public function down() {
    //
    DB::statement(
      "ALTER TABLE items_log CHANGE COLUMN sender_type sender_type ENUM('User', 'Character') DEFAULT 'User'"
    );
    DB::statement(
      "ALTER TABLE items_log CHANGE COLUMN recipient_type recipient_type ENUM('User', 'Character') DEFAULT 'User'"
    );
