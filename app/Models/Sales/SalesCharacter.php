    ...
    switch ($this->type) {
      ...
      case 'auction':
        return 'Starting Bid: ' .
          ...
          'Minimum Increment: ' .
          $symbol .
          $this->data['min_increment'] .
          (isset($this->data['autobuy'])
            ? '<br/>Autobuy: ' . $symbol . $this->data['autobuy']
            : '');
        break;
      case 'ota':
        return (isset($this->data['autobuy'])
          ? 'Autobuy: ' . $symbol . $this->data['autobuy'] . '<br/>'
          : '') .
          (isset($this->data['minimum'])
            ? 'Minimum: ' . $symbol . $this->data['minimum'] . '<br/>'
            : '');
        break;
      case 'xta':
        return (isset($this->data['autobuy'])
      ...
      case 'flaffle':
        ...
        break;
      case 'pwyw':
        return isset($this->data['minimum'])
          ? 'Minimum: ' . $symbol . $this->data['minimum'] . '<br/>'
          : '';
        break;
    }
