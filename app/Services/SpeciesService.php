  ...
  public function deleteSpecies($species) {
    ...
    try {
      ...
      if (CharacterImage::where('species_id', $species->id)->exists()) {
        throw new \Exception(
          'A character image with this species exists. Please change its species first.'
        );
      }
  ...
  public function deleteSubtype($subtype) {
    ...
    try {
      ...
      if (CharacterImage::where('subtype_id', $subtype->id)->exists()) {
        throw new \Exception(
          'A character image with this subtype exists. Please change or remove its subtype first.'
        );
      }
