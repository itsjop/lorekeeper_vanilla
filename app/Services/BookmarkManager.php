  ...
  public function createBookmark($data, $user) {
    ...
    try {
      ...
      $bookmark = CharacterBookmark::create([
        ...
        'user_id' => $user->id,
        'sort' => 0,
        'notify_on_trade_status' => isset($data['notify_on_trade_status'])
          ? $data['notify_on_trade_status']
          : 0,
        'notify_on_gift_art_status' => isset($data['notify_on_gift_art_status'])
          ? $data['notify_on_gift_art_status']
          : 0,
        'notify_on_gift_writing_status' => isset($data['notify_on_gift_writing_status'])
          ? $data['notify_on_gift_writing_status']
          : 0,
        'notify_on_transfer' => isset($data['notify_on_transfer'])
          ? $data['notify_on_transfer']
          : 0,
